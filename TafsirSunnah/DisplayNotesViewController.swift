...
class DNTransitioner : NSObject, UIViewControllerTransitioningDelegate {
    func presentationController(
        forPresented presented: UIViewController,
        presenting: UIViewController?,
        source: UIViewController)
        -> UIPresentationController? {
            return DNPresentationController(
                presentedViewController: presented, presenting: presenting)
    }
}

class DNPresentationController : UIPresentationController, UITextViewDelegate {
    ...
    override var frameOfPresentedViewInContainerView : CGRect {
        ...
        let con = self.containerView!
        v.center = CGPoint(x: con.bounds.midX, y: con.bounds.midY - 90)
...
extension DNTransitioner { // UIViewControllerTransitioningDelegate
...
extension DNTransitioner : UIViewControllerAnimatedTransitioning {
