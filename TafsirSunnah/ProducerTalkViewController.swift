...
class ProducerTalkViewController : UIViewController {
    let transitioner = PTTransitioner()
...
class PTTransitioner : NSObject, UIViewControllerTransitioningDelegate {
    func presentationController(
        forPresented presented: UIViewController,
        presenting: UIViewController?,
        source: UIViewController)
        -> UIPresentationController? {
            return PTPresentationController(
                presentedViewController: presented, presenting: presenting)
    }
}

class PTPresentationController : UIPresentationController, UITextViewDelegate {
...
extension PTTransitioner { // UIViewControllerTransitioningDelegate
...
extension PTTransitioner : UIViewControllerAnimatedTransitioning {
