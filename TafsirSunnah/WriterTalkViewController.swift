...
class WriterTalkViewController : UIViewController {
    let transitioner = WTTransitioner()
...
class WTTransitioner : NSObject, UIViewControllerTransitioningDelegate {
    func presentationController(
        forPresented presented: UIViewController,
        presenting: UIViewController?,
        source: UIViewController)
        -> UIPresentationController? {
            return WTPresentationController(
                presentedViewController: presented, presenting: presenting)
    }
}

class WTPresentationController : UIPresentationController, UITextViewDelegate {
...
extension WTTransitioner { // UIViewControllerTransitioningDelegate
...
extension WTTransitioner : UIViewControllerAnimatedTransitioning {
